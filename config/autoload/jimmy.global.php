...
// 'baseurl'   => 'http://dev.jimmydata.com/',
// 'clienturl' => 'http://dev.reports.jimmydata.com/',
...
// Change baseurl and clienturl for local site.
if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') {
    $jimmy_settings['baseurl'] = 'http://dev.jimmydata.com/';
    $jimmy_settings['clienturl'] = 'http://dev.reports.jimmydata.com/';
    $jimmy_settings['jimmy-env'] = 'sandbox';
}
...
if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') {
    $google_settings['client_id'] = '757365770318-n1sqchh6qrlm2t5eonmaat0e61gdehdv.apps.googleusercontent.com';
    $google_settings['client_secret'] = 'AhlYaasYP8vjbkjKk1TQT7rZ';
}
