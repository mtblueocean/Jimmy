...
if (!class_exists("ExpressBusinessService", false)) {
  ...
  class ExpressBusinessService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/express/v201708";
    const ENDPOINT = "https://adwords.google.com/api/adwords/express/v201708/ExpressBusinessService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/express/v201708/ExpressBusinessService";
    /**
