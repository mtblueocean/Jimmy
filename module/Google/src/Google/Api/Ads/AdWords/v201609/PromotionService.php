...
if (!class_exists("PromotionService", false)) {
  ...
  class PromotionService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/express/v201708";
    const ENDPOINT = "https://adwords.google.com/api/adwords/express/v201708/PromotionService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/express/v201708/PromotionService";
    /**
