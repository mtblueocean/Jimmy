...
if (!class_exists("AdGroupFeedService", false)) {
  ...
  class AdGroupFeedService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201708";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201708/AdGroupFeedService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201708/AdGroupFeedService";
    /**
