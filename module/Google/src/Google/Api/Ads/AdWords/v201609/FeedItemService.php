...
if (!class_exists("FeedItemService", false)) {
  ...
  class FeedItemService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201708";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201708/FeedItemService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201708/FeedItemService";
    /**
