...
if (!class_exists("TargetingIdeaService", false)) {
  ...
  class TargetingIdeaService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/o/v201708";
    const ENDPOINT = "https://adwords.google.com/api/adwords/o/v201708/TargetingIdeaService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/o/v201708/TargetingIdeaService";
    /**
