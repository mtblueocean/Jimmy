...
if (!class_exists("CollectionSizeError", false)) {
  ...
  class CollectionSizeError extends ApiError {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/rm/v201708";
...
if (!class_exists("AdwordsUserListService", false)) {
  ...
  class AdwordsUserListService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/rm/v201708";
    const ENDPOINT = "https://adwords.google.com/api/adwords/rm/v201708/AdwordsUserListService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/rm/v201708/AdwordsUserListService";
    /**
