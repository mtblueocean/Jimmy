...
if (!class_exists("SharedSetService", false)) {
  ...
  class SharedSetService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201708";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201708/SharedSetService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201708/SharedSetService";
    /**
