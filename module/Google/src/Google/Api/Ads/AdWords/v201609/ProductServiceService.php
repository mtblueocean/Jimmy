...
if (!class_exists("ProductServiceService", false)) {
  ...
  class ProductServiceService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/express/v201708";
    const ENDPOINT = "https://adwords.google.com/api/adwords/express/v201708/ProductServiceService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/express/v201708/ProductServiceService";
    /**
