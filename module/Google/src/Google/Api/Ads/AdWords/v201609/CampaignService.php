 ...
 *
 * @package    Google_Api_Ads_AdWords_v201708
 * @subpackage v201708
...
if (!class_exists("CampaignService", false)) {
  ...
  class CampaignService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201708";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201708/CampaignService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201708/CampaignService";
    /**
