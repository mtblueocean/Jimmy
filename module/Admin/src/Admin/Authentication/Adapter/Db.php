...
use Admin\Authentication\Adapter\AdapterChainEvent as AuthEvent;
use Admin\Mapper\User as UserMapperInterface;
...
class Db extends AbstractAdapter implements ServiceManagerAwareInterface
{
    ...
    public function authenticate(AuthEvent $e)
    {
        ...
        if ($this->isSatisfied()) {
            ...
            $e->setIdentity($storage['admin_identity'])
        ...
        $storage['admin_identity'] = $e->getIdentity();
    ...
    {
        if (null === $this->mapper) {
            $this->mapper = $this->getServiceManager()->get('admin_user_mapper');
        }
        return $this->mapper;
    }
