...
namespace JimmyBase\Validator;

use Zend\Validator\AbstractValidator;
use JimmyBase\Mapper\ClientInterface;
    ...
    protected function query($value)
    {
        ...
        switch ($this->getKey()) {
            case 'email':
                ...
                break;  
            case 'adwords_client_id':
                $result = $this->getMapper()->findByAdwordsClientId($value);
                break;
            
            default:
                throw new \Exception('Invalid key used in Client validator');
                break;
        }
