...
use Application\Controller\DashboardApiController;
...
class DashboardApiControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->routeMatch = new RouteMatch(array('controller' => 'DashboardApi'));
